...
```javascript
INT16_MAX = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-int16-max@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-int16-max@umd/bundle.js"></script>
```
